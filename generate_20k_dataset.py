...
en_templates = [
    ...
    "How does {topic} improve efficiency?",
    "Recent advancements in {topic} are remarkable.",
    "Applications of {topic} are growing worldwide.",
    "Students presented key concepts of {topic}.",
    "Practical training in {topic} builds confidence."
]
...
hi_templates = [
    ...
    "{topic} दक्षता में कैसे सुधार करता है?",
    "{topic} में हाल की प्रगति उल्लेखनीय है।",
    "दुनिया भर में {topic} के अनुप्रयोग बढ़ रहे हैं।",
    "छात्रों ने {topic} की प्रमुख अवधारणाएँ प्रस्तुत कीं।",
    "{topic} में व्यावहारिक प्रशिक्षण आत्मविश्वास बढ़ाता है।"
]
...
df.to_csv("data/sample_en_hi_20k.csv", index=False, encoding="utf-8")
print(f"Generated {len(df)} sentence pairs in 'data/sample_en_hi_20k.csv'")
